function out = runR23AasEirpCdfGridExample()
...
%
%   Plots the mean and P50 / P95 maps, saves PNG / CSV / metadata under
...
%       runR23AasEirpCdfGridExample
    ...
    fprintf('  sectorEirpDbm        : %.2f dBm / 100 MHz\n', ...
        out.stats.sectorEirpDbm);
    fprintf('  perBeamPeakEirpDbm   : %.2f dBm / 100 MHz (3-beam split)\n', ...
        perBeamPeak);
